# re-usable nice heatmap functions
'''
Copyright (c) 2019, Drazen Zaric
All rights reserved.
'''

# I have modified the code to add return to two functions
...
def heatmap(x, y, **kwargs):
    ...
    kwargs_pass_on = {k:v for k,v in kwargs.items() if k not in [
         'color', 'palette', 'color_range', 'size', 'size_range', 'size_scale', 'marker', 'x_order', 'y_order', 'xlabel', 'ylabel','figsize'
    ]}
...
def corrplot(data, size_scale=500, marker='s',figsize=(10,10)):
...
# corrplot and heatmap return two axes objects, each corresponding to the scatter plot
# and side_bar
